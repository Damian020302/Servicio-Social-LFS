...
public class EnemySpawner : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        if (enemyPrefabs != null && selectedIndex < enemyPrefabs.Length) selectedEnemy = enemyPrefabs[selectedIndex];
        else
        {
            if (enemyPrefabs.Length > 0) selectedEnemy = enemyPrefabs[0];
    ...
    {
        if(enemySpawners.Length == 0 || selectedEnemy == null) return;
