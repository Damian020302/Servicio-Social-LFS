...
public class WandSpawner : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        if(wandPrefabs != null && selectedIndex < wandPrefabs.Length) selectedWand = wandPrefabs[selectedIndex];
        else
        {
            if(wandPrefabs.Length > 0) selectedWand = wandPrefabs[0];
    ...
    /// <summary>
    /// Spawns the selected wand at the wand spawner's position and rotation.
    /// </summary>
